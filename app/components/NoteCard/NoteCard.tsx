...
const NoteCard = ({ note }: INoteCard) => {
    ...
    return (
        <div className="min-w-[30vw] p-6 hover:bg-gray-700 border rounded-lg shadow bg-gray-800 border-gray-700">
            ...
            <div className='flex'>
                <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none  focus:ring-blue-800">
                    Read more
